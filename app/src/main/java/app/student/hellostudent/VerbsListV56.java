...
public class VerbsListV56 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbs_list_v56);
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV56.this, MainActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV56.this, VerbsListV57.class);
                    startActivity(intent);
                    finish();
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV56.this, VerbsListV55.class);
                    startActivity(intent);
                    finish();
                } catch (Exception v1_next_error) {};
            }
    ...
    private void speak()
    {
        String text = "Think. Thought. Thought.";
        float pitch = (float) 1;
        float speed = (float) 1;
