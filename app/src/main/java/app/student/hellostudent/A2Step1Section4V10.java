...
public class A2Step1Section4V10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a2_step1_section4_v10);
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(A2Step1Section4V10.this, A2Step1.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step1Section4V10.this, A2Step1Section4V11.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step1Section4V10.this, A2Step1Section4V9.class);
                startActivity(intent);
                finish();
            }
        });
