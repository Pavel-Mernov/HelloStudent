...
public class RevisionV22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_revision_v22);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV22.this, RevisionV23.class);
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV22.this, RevisionV21.class);
                    startActivity(intent);
                    finish();
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV22.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                } catch (Exception error) {}
            }
