...
public class A1Step2Section2V2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a1_step2_section2_v2);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(A1Step2Section2V2.this, A1Step2Section2V3.class);
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(A1Step2Section2V2.this, A1Step2Section2V1.class);
                    startActivity(intent);
                    finish();
                } catch (Exception error_next_a1_step2_sect2) {}
            }
