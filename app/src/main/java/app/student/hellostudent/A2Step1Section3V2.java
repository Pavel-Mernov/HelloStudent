...
public class A2Step1Section3V2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a2_step1_section3_v2);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(A2Step1Section3V2.this, A2Step1Section3V3.class);
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step1Section3V2.this, A2Step1Section3V1.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step1Section3V2.this, A2Step1.class);
                startActivity(intent);
                finish();
            }
        });
