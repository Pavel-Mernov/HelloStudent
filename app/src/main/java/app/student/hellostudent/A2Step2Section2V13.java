...
public class A2Step2Section2V13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a2_step2_section2_v13);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(A2Step2Section2V13.this, A2Step2Section2V14.class);
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(A2Step2Section2V13.this, A2Step2.class);
                    startActivity(intent);
                    finish();
