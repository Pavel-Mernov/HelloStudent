...
public class RevisionV23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_revision_v23);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV23.this, RevisionV24.class);
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV23.this, RevisionV22.class);
                    startActivity(intent);
                    finish();
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV23.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                } catch (Exception error) {}
            }
        ...
        btnA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                restart();
                letterA.setTextColor(getResources().getColor(R.color.colorDarkRed2));
                textA.setTextColor(getResources().getColor(R.color.colorDarkRed2));
                textShow.setText(textA.getText());
                textShow.setTextColor(textA.getCurrentTextColor());
        ...
        btnB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                textShow.setTextColor(textB.getCurrentTextColor());
                imgLine.setBackgroundColor(getResources().getColor(R.color.colorDarkRed2));
                imgCorrect.setBackground(getResources().getDrawable(R.drawable.button_red));
                imgCorrect.setImageDrawable(getResources().getDrawable(R.drawable.img_cross));
                imgCorrect.setVisibility(View.VISIBLE);
        ...
        btnC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                textShow.setTextColor(textC.getCurrentTextColor());
                imgLine.setBackgroundColor(getResources().getColor(R.color.colorDarkRed2));
                imgCorrect.setBackground(getResources().getDrawable(R.drawable.button_red));
                imgCorrect.setImageDrawable(getResources().getDrawable(R.drawable.img_cross));
                imgCorrect.setVisibility(View.VISIBLE);
        ...
        btnD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                restart();
                letterD.setTextColor(getResources().getColor(R.color.colorDarkGreen));
                textD.setTextColor(getResources().getColor(R.color.colorDarkGreen));
                textShow.setText(textD.getText());
                textShow.setTextColor(textD.getCurrentTextColor());
