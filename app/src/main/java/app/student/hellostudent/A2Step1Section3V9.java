...
public class A2Step1Section3V9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a2_step1_section3_v9);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(A2Step1Section3V9.this, A2Step1Section3V10.class);
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step1Section3V9.this, A2Step1Section3V8.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step1Section3V9.this, A2Step1.class);
                startActivity(intent);
                finish();
            }
        });
