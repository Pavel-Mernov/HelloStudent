...
public class VerbsListV1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbs_list_v1);

        btnExit = (ConstraintLayout) findViewById(R.id.btnExit_verbs_list_v1);
        btnExit.setOnClickListener(new View.OnClickListener() {
          @Override
            public void onClick(View v) {
                try {
                   Intent intent = new Intent(VerbsListV1.this, MainActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV1.this, VerbsListV2.class);
                    startActivity(intent);
                    finish();
