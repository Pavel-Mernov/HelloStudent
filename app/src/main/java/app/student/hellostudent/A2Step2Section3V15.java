...
public class A2Step2Section3V15 extends AppCompatActivity {
    TextView btnExit;
    EditText input_main;
    TextView btnCheck;
    TextView btnRestart;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a2_step2_section3_v15);

        btnExit = (TextView) findViewById(R.id.btnExit);
        btnExit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step2Section3V15.this, A2Step2.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step2Section3V15.this, A2Step2Section3V16.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step2Section3V15.this, A2Step2Section3V14.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnCheck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (input_main.getText().toString().trim().equals("heard"))
                {
