...
public class RevisionV13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_revision_v13);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV13.this, RevisionV14.class);
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV13.this, RevisionV12.class);
                    startActivity(intent);
                    finish();
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV13.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                } catch (Exception error) {}
            }
        ...
        btnC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                restart();
                letterC.setTextColor(getResources().getColor(R.color.colorDarkGreen));
                textC.setTextColor(getResources().getColor(R.color.colorDarkGreen));
