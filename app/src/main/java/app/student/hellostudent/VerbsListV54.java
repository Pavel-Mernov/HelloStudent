...
public class VerbsListV54 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbs_list_v54);
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV54.this, MainActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV54.this, VerbsListV55.class);
                    startActivity(intent);
                    finish();
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV54.this, VerbsListV53.class);
                    startActivity(intent);
                    finish();
                } catch (Exception v1_next_error) {};
            }
    ...
    private void speak()
    {
        String text = "Teach. Taught. Taught.";
        float pitch = (float) 1;
        float speed = (float) 1;
