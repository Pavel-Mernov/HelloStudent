...
public class VerbsListV30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbs_list_v30);
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV30.this, MainActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV30.this, VerbsListV31.class);
                    startActivity(intent);
                    finish();
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV30.this, VerbsListV29.class);
                    startActivity(intent);
                    finish();
                } catch (Exception v1_next_error) {};
            }
