...
public class RevisionV11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_revision_v11);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV11.this, RevisionV12.class);
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV11.this, RevisionV10.class);
                    startActivity(intent);
                    finish();
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV11.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                } catch (Exception error) {}
            }
