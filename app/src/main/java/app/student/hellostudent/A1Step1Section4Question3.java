...
public class A1Step1Section4Question3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a1_step1_section4_question3);
        ...
        btn_finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    Intent intent = new Intent(A1Step1Section4Question3.this, A1Step1Sections.class);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(A1Step1Section4Question3.this, A1Step1Section4Question4.class);
                    startActivity(intent);
                    finish();
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(A1Step1Section4Question3.this, A1Step1Section4Question2.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e_next) {}
            }
        ...
        btn_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!input_main.getText().toString().trim().equals(""))
                {
                    ...
                    closeKeyboard();
                    if (input_main.getText().toString().trim().equals("was"))
                    {
