...
public class RevisionV19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_revision_v19);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV19.this, RevisionV20.class);
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV19.this, RevisionV18.class);
                    startActivity(intent);
                    finish();
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(RevisionV19.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                } catch (Exception error) {}
            }
        ...
        btnB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                restart();
                letterB.setTextColor(getResources().getColor(R.color.colorDarkGreen));
                textB.setTextColor(getResources().getColor(R.color.colorDarkGreen));
