...
public class A1Step2Section4Question8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a1_step2_section4_question8);
        ...
        btn_finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    Intent intent = new Intent(A1Step2Section4Question8.this, A1Step2Sections.class);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(A1Step2Section4Question8.this, A1Step2Section4Question9.class);
                    startActivity(intent);
                    finish();
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(A1Step2Section4Question8.this, A1Step2Section4Question7.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e_next) {}
            }
        ...
        btn_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!input_main.getText().toString().trim().equals(""))
                {
                    ...
                    closeKeyboard();
                    if (input_main.getText().toString().trim().equals("drove"))
                    {
