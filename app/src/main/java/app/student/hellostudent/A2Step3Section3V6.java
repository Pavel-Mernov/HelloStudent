...
public class A2Step3Section3V6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a2_step3_section3_v6);
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(A2Step3Section3V6.this, A2Step3.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step3Section3V6.this, A2Step3Section3V7.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2Step3Section3V6.this, A2Step3Section3V5.class);
                startActivity(intent);
                finish();
            }
        });
