...
public class VerbsListV45 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbs_list_v45);
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV45.this, MainActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV45.this, VerbsListV46.class);
                    startActivity(intent);
                    finish();
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(VerbsListV45.this, VerbsListV44.class);
                    startActivity(intent);
                    finish();
                } catch (Exception v1_next_error) {};
            }
